...
# Pass transforms in here and load the model
...
classifier = nn.Sequential(
    ...
    nn.ReLU(),
    nn.Dropout(p=0.2),
    nn.Linear(512, 2), # We have 2 outputs, cats and dogs
    nn.LogSoftmax(dim=1)
)

# Replace the model's classifier with the new classifier' and check the new model's architecture.
model.fc = classifier
